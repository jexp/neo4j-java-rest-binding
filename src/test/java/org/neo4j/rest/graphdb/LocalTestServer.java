...
public class LocalTestServer {
    ...
    public void start() {
        ...
        final Bootstrapper bootstrapper = new Bootstrapper() {
            @Override
            protected org.neo4j.server.database.GraphDatabaseFactory getGraphDatabaseFactory(Configuration configuration) {
                return new org.neo4j.server.database.GraphDatabaseFactory() {
                    @Override
